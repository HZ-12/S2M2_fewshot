...
def parse_args(script):
    ...
    parser.add_argument('--method'      , default='S2M2_R',   help='rotation//manifold_mixupS2M2_R') #relationnet_softmax replace L2 norm with softmax to expedite training, maml_approx use first-order approximation in the gradient for efficiency
